...
/**
 * Representación de un AFD (autómata finito determinista).
 * Estructura basada en las indicaciones del profesor:
 * - alfabeto: List<Character>
 * - estados: List<Integer>
 * - estado inicial: int
 * - estados finales: Set<Integer>
 * - matriz: Map<estado, Map<caracter, estadoDestino>>
 *
 * Nota: se usa Character como "elemento del alfabeto". Si quieres categorías
 * como LETTER o DIGIT, usa tokens 'L' y 'D' (u otros) en el alfabeto y
 * premapéalos antes de simular.
 */
public class AFD {
     ...
     * Debes llamar a este método después de crear estados y alfabeto (o cada vez
     * que añadas estados nuevos).
     */
