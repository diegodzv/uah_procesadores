// File: MaquinaEstados.java
/**
 * Máquina de estados que "habla" con un AFD y guarda el estado actual.
 * Proporciona:
 * - inicializar() -> pone estadoActual al estado inicial del AFD
 * - acepta(char) -> consume un carácter (actualiza estadoActual o lanza excepción)
 * - esFinal() -> boolean
 * - compruebaCadena(String) -> recorre la cadena y devuelve true si se acepta
 *
 * Para soportar alfabetos con categorías (p. ej. 'L' para letter, 'D' para digit),
 * MaquinaEstados admite un CharMapper que transforma caracteres de entrada a los
 * caracteres del alfabeto del AFD.
 */
...
public class MaquinaEstados {
     ...
     *               Si no quieres mapear, pasa c -> c (identity).
     */
     ...
     *
     * (Sigue el esquema del profesor: para cada carácter llama a acepta(), y
     *  al final comprueba esFinal()).
     */
